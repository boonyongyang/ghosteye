...
enum ScriptExportFormat { fountain, plainText }

typedef ShareScriptTextFn =
...
class ScriptExportService {
  ...
  ScriptExportDocument buildDocument({
    ...
    final text = switch (format) {
      ScriptExportFormat.fountain => _buildFountain(
        cleanedEntries,
        exportTitle,
        capturedAt,
        trimmedNotes,
      ),
      ScriptExportFormat.plainText => _buildPlainText(
        cleanedEntries,
        exportTitle,
        capturedAt,
        trimmedNotes,
      ...
      for (var index = 0; index < entries.length; index++) {
        ...
        final shouldInsertBlankLine = switch (entry.type) {
          ...
          ScriptEntryType.dialogue =>
            nextType != ScriptEntryType.dialogue &&
  ...
  static String _buildPlainText(
    ...
    if (entries.isEmpty) {
      ...
      for (final entry in entries) {
        buffer.writeln(switch (entry.type) {
